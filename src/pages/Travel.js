...
const Travel = ( props ) => {
    ...
    return (
        <React.Fragment>
            <Navbar />
            <div className='loss-jumbo-container travel-bcg' style={{backgroundColor: '#9C74FF'}}> 
                <div>
                    <p className='paragraph' style={{color: '#0E1525', fontWeight: 'bold'}}><img className='small-shield-img' src={smalltravel} /> Travel Insurance</p>
                    <h3 className='loss-header'>Get <span style={{fontWeight: 'bold'}}>Travel Insurance </span>that works</h3>
                ...
                <div className='job-loss-img-div'>
                    <img className='job-loss-img' src={travel} alt='travel' />
                </div>
            </div>
            ...
            <div className='flex-out'>
                <div className='calculator-div'>
                    <h4 className='paragraph align-center loss-para text-bold' style={{fontWeight: 'bold'}}> Travel Insurance Calculator</h4>
                    <div>
